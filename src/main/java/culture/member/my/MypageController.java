...
public class MypageController {
	...
	public void generateQRcode(HttpServletRequest request, HttpSession session) throws WriterException, IOException {
		...
		String qrCodeText = "http://localhost:8080/culture/concert/CultureDetail.cul?culture_idx="
				+ request.getParameter("culture_idx");
		String fileName = System.currentTimeMillis() + "_" + "QRcode.png";
		String filePath = "/Users/kimjihoon/Documents/spring/mavenApp/culture/src/main/webapp/WEB-INF/qrcode/"
				+ fileName;
		int size = 100;
		String fileType = "png";
	...
	public ModelAndView mypage(@ModelAttribute("member") MemberModel member, BindingResult result,
	...
	public ModelAndView ModifyForm(@ModelAttribute("member") MemberModel member, BindingResult result,
			HttpServletRequest requeset, HttpSession session) {
		MemberModel MemberModel;
		String MEMBER_ID;
