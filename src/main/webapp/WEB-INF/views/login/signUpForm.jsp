...
<div id="bg">
	...
	<br>
		...
		<div class="form-group">
			...
			<form:input type="text" class="form-control" id="MEMBER_NAME"
				path="MEMBER_NAME" placeholder="이름을 입력해 주세요" />
		</div>
		<div class="form-group">
			<label for="InputEmail">이메일 주소</label>
			<form:input type="email" class="form-control" id="MEMBER_EMAIL"
		...
		<input type="password" name="MEMBER_PASSWORD" id="MEMBER_PASSWORD"
			path="MEMBER_PASSWORD" class="form-control" required />
		<br>
		...
		<br>
			...
			<button type="submit" class="btn btn-info" value="signUp"  />
	</form:form>
