      ...
      <form action="MemberModify.cul" method="get">
         ...
         <tbody>
               <tr>
                  ...
                  <th scope="row">공연명</th>
                  <td><input type="text" id="CULTURE_NAME" name="CULTURE_NAME"
                     class="background-white form-control border-color-primary" value="${culture.CULTURE_NAME }"></td>
               </tr>

            <tr>
                    <th>카테고리</th>
                        <td><div class="default-select" id="default-select" "="">
                        <select name="CULTURE_CATEGORY" class="nice-select" value="${culture.CULTURE_CATEGORY }">
               ...
               <tr>
                  ...
                  <td><input type="text" id="CULTURE_LOCATION"
                     name="CULTURE_LOCATION" class="background-white form-control border-color-primary"
               ...
               <tr>
                  ...
                  <td><input type="text" id="CULTURE_START"
                     name="CULTURE_START" class="background-white form-control border-color-primary"
                     value="${culture.CULTURE_START } "></input></td>
               </tr>


               <tr>
                  <th scope="row">종료날짜</th>
                  <td><input type="text" id="CULTURE_END" name="CULTURE_END"
                     class="background-white form-control border-color-primary" value="${culture.CULTURE_END }"></input></td>
               </tr>
               ...
               <tr>
                  ...
                  <td><input type="textarea"
                     style="width: 300px; height: 400px;" id="CULTURE_CONTENT"
                     name="CULTURE_CONTENT" class="background-white form-control border-color-primary"
