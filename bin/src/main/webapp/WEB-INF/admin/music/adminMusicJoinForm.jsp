				...
				<table>
					...
					<tbody>
						 ...
						 <tr>
							...
							<td><input type="text" id="TITLE" name="TITLE" class="wdp_90" value="${adminMusicForm.MUSIC_ALBUM}"></input>
						...
						<tr>
							...
							<td><select name="job">
   							 ...
   							 <option value="학생">발라드</option>
  							  <option value="회사원">R&B</option>
  							  <option value="기타">POP</option>
  							  <option value="기타">힙합</option>
  							  <option value="기타">댄스</option>
  							  <option value="기타">ROCK</option>
  							  <option value="기타">트로트</option>
						...
						<tr>
							...
							<td><select name="country">
   							 ...
   							 <option value="학생">한국</option>
  							  <option value="회사원">미국</option>
  							  <option value="기타">일본</option>
  							  <option value="기타">중국</option>
  							  <option value="기타">대만</option>
  							  <option value="기타">기타</option>
								</select>
								<font color="red" ><form:errors path="movie_info" /></font>
							</td>
					...
					<tr>
							<th scope="row">포스터</th>
							<td>
								<input Class="txt" type="file" name="poster" />
